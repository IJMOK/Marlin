...
#define STRING_CONFIG_H_AUTHOR "(Rob Evans, Q5 config)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 200.53            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -2.26, 0.0, -0.825 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 108.01             // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.102, 0.093, -0.009 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 412.6 }  // default steps per unit
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.575 }
